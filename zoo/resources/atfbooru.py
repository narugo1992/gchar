...
from .danbooru.tags import crawl_tags_to_json, json_save_to_csv, json_save_to_sqlite

print_version = partial(_origin_print_version, 'zoo.resources.atfbooru')


@click.group(context_settings={**GLOBAL_CONTEXT_SETTINGS}, help='Crawler of booru.allthefallen.moe')
...
@click.option('--namespace', '-n', 'namespace', type=str, default='booru.allthefallen.moe',
...
def tags(repository: str, namespace: str, revision: str):
    ...
    data = crawl_tags_to_json('https://booru.allthefallen.moe')
