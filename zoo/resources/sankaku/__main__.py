...
@click.group(context_settings={**GLOBAL_CONTEXT_SETTINGS}, help='Crawler of chan.sankakucomplex.com')
...
@click.option('--namespace', '-n', 'namespace', type=str, default='chan.sankakucomplex.com',
