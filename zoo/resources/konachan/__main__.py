...
@click.group(context_settings={**GLOBAL_CONTEXT_SETTINGS}, help='Crawler of konachan.com')
...
@click.option('--namespace', '-n', 'namespace', type=str, default='konachan.com',
...
def tags(repository: str, namespace: str, revision: str):
    ...
    data = crawl_tags_to_json(direct=True)
