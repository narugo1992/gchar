...
@click.group(context_settings={**GLOBAL_CONTEXT_SETTINGS}, help='Crawler of xbooru.com')
...
@click.option('--namespace', '-n', 'namespace', type=str, default='xbooru.com',
...
def tags(repository: str, namespace: str, revision: str):
    ...
    data = crawl_tags_to_json('https://xbooru.com')
