...
@click.group(context_settings={**GLOBAL_CONTEXT_SETTINGS}, help='Crawler of safebooru.donmai.us')
...
@click.option('--namespace', '-n', 'namespace', type=str, default='safebooru.donmai.us',
...
def tags(repository: str, namespace: str, revision: str):
    ...
    data = crawl_tags_to_json('https://safebooru.donmai.us')
